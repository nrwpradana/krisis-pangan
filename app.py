...
st.markdown(""">*<p style="font-family:Arial; color:Black; font-size: 16px; text-align: justify">\
            ...
            Salah satunya adalah <b>krisis pangan global lainnya yang tumpang tindih dengan krisis pangan akibat Covid-19</b>. Hal ini karena kedua negara memiliki posisi yang signifikan sebagai produsen komoditas terkait pangan.\
            Di penelitian ini akan membahas tentang <b>seberapa banyak perubahan yang telah diambil pasar makanan global selama krisis</b>, \
...
with ua_ina:
    ...
    <b> Indonesia bergantung pada ekspor dari Ukraina sebesar 1,1% total ekspor Ukraina atau sebesar 735 Juta USD</b>. Dengan adanya konflik antara Ukraina dan Rusia secara tidak langsung akan \
    menyebabkan rantai pasok pangan dari Ukraina ke Indonesia terganggu.<br>', 
    unsafe_allow_html=True)

    with st.expander("DETAIL EKSPOR UKRAINA KE INDONESIA 2021"):
        st.markdown("---")
        ua_ina_chart = """
        <div class='tableauPlaceholder' id='viz1666064426610' style='position: relative'><noscript><a href='#'><img alt='Ekspor Ukraina ke Indonesia Tahun 2021 ' src='https:&#47;&#47;public.tableau.com&#47;static&#47;images&#47;Bo&#47;Bool1_16660642038350&#47;Sheet1&#47;1_rss.png' style='border: none' /></a></noscript><object class='tableauViz'  style='display:none;'><param name='host_url' value='https%3A%2F%2Fpublic.tableau.com%2F' /> <param name='embed_code_version' value='3' /> <param name='site_root' value='' /><param name='name' value='Bool1_16660642038350&#47;Sheet1' /><param name='tabs' value='no' /><param name='toolbar' value='yes' /><param name='static_image' value='https:&#47;&#47;public.tableau.com&#47;static&#47;images&#47;Bo&#47;Bool1_16660642038350&#47;Sheet1&#47;1.png' /> <param name='animate_transition' value='yes' /><param name='display_static_image' value='yes' /><param name='display_spinner' value='yes' /><param name='display_overlay' value='yes' /><param name='display_count' value='yes' /><param name='language' value='en-US' /><param name='filter' value='publish=yes' /></object></div>                <script type='text/javascript'>                    var divElement = document.getElementById('viz1666064426610');                    var vizElement = divElement.getElementsByTagName('object')[0];                    vizElement.style.width='100%';vizElement.style.height=(divElement.offsetWidth*0.75)+'px';                    var scriptElement = document.createElement('script');                    scriptElement.src = 'https://public.tableau.com/javascripts/api/viz_v1.js';                    vizElement.parentNode.insertBefore(scriptElement, vizElement);                </script>
        """
        components.html(ua_ina_chart,height=450)
        st.caption('Sumber : Ukraine Exports to Indonesia, https://tradingeconomics.com/ukraine/exports/indonesia')
...
with ru_ina:
    ...
    <b> Indonesia bergantung pada ekspor dari Ukraina sebesar 0,14% total ekspor Rusia atau sebesar 681 Juta USD</b>. Dengan adanya konflik antara Ukraina dan Rusia secara tidak langsung akan \
    menyebabkan rantai pasok pangan dari Rusia ke Indonesia terganggu.<br>', 
    unsafe_allow_html=True)

    with st.expander("DETAIL EKSPOR RUSIA KE INDONESIA 2021"):
        st.markdown("---")
        rus_ina_chart = """
        <div class='tableauPlaceholder' id='viz1666075719556' style='position: relative'><noscript><a href='#'><img alt='Sheet 2 ' src='https:&#47;&#47;public.tableau.com&#47;static&#47;images&#47;co&#47;cobarus&#47;Sheet2&#47;1_rss.png' style='border: none' /></a></noscript><object class='tableauViz'  style='display:none;'><param name='host_url' value='https%3A%2F%2Fpublic.tableau.com%2F' /> <param name='embed_code_version' value='3' /> <param name='site_root' value='' /><param name='name' value='cobarus&#47;Sheet2' /><param name='tabs' value='no' /><param name='toolbar' value='yes' /><param name='static_image' value='https:&#47;&#47;public.tableau.com&#47;static&#47;images&#47;co&#47;cobarus&#47;Sheet2&#47;1.png' /> <param name='animate_transition' value='yes' /><param name='display_static_image' value='yes' /><param name='display_spinner' value='yes' /><param name='display_overlay' value='yes' /><param name='display_count' value='yes' /><param name='language' value='en-US' /><param name='filter' value='publish=yes' /></object></div>                <script type='text/javascript'>                    var divElement = document.getElementById('viz1666075719556');                    var vizElement = divElement.getElementsByTagName('object')[0];                    vizElement.style.width='100%';vizElement.style.height=(divElement.offsetWidth*0.75)+'px';                    var scriptElement = document.createElement('script');                    scriptElement.src = 'https://public.tableau.com/javascripts/api/viz_v1.js';                    vizElement.parentNode.insertBefore(scriptElement, vizElement);                </script>
        """
