...
st.markdown(p_format +'Konflik Ukraina-Rusia memberikan dampak yang besar bagi pasokan bahan pangan dan pertanian global, termasuk dengan Indonesia yang memiliki hubungan perdagangan dengan Ukraina dan Rusia.', unsafe_allow_html=True)
st.markdown("""><h6 style="font-family:Papyrus; background-color: white"><b>Seberapa besar ketergantungan Indonesia terhadap pasokan bahan pangan dan pertanian dari Ukraina dan Rusia ?</b></h6>""", unsafe_allow_html=True)
