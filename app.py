...
st.markdown(""">*<p style="font-family:Arial; color:Black; font-size: 16px;">\
            ...
            dan <b>bagaimana jika dibandingkan</b> dengan krisis harga pangan terkenal lainnya selama abad ke-21, yang dalam hal ini <b>Krisis Harga Pangan 2007-2008.</b><br></p>*""",
            unsafe_allow_html=True)
